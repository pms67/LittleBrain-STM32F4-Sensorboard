...
/*
 *
 * Little Brain PCB Firmware + FreeRTOS
 *
...
osThreadId taskKalmanFilteHandle;
/* USER CODE BEGIN PV */
BMI088 imu;
SPL06  bar;
/* USER CODE END PV */
...
/* USER CODE BEGIN Header_taskTaskPressure */
/**
* @brief Function implementing the taskPressure thread.
* @param argument: Not used
* @retval None
*/
...
void taskTaskPressure(void const * argument)
{
  ...
  /* USER CODE END taskTaskPressure */
}
